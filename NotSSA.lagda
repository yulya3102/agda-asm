...
Ранее для описания типа инструкций использовался список регистров,
добавляемых к уже имеющимся. Это приводило к тому, что никакая инструкция
не могла изменить уже добавленные ранее регистры. Указанную проблему можно
решить, введя тип, описывающий изменение списка регистров, и соответственно
...
применяется изменение, будем называть контекстом.
...
регистров заменим на описание набора изменений.
