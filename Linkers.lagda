...
себе указатели на код, заполняемые динамическим загрузчиком в рантайме,
вторая же содержит блоки
...
Как было сказано в секции \ref{sec:asm-review}, последним
параметром типа блока является описание изменений типа состояния исполнителя,
