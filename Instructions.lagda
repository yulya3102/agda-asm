...
\begin{itemize}
    ...
    \item
        вызов на соответствующий блок кода, лежащий в памяти по данному
        адресу;
        \textbf{TODO: вызов? серьезно? как вообще нормально по-русски
        сказать "call"?}
...
\textbf{TODO:
В этом абзаце нужно вспомнить, что я хочу заменить "просто инструкции" на
что-нибудь вменяемое
}
