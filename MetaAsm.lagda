...
листинге \ref{fig:statetype}. \textbf{\emph{TODO: что есть что}}
...
Индуктивное определение \emph{блока кода} приведено в листинге \ref{fig:block}. \textbf{\emph{TODO: что есть что}}
...
\emph{программы}. Так, для (\textbf{\emph{TODO: а для не управляющих?}}) управляющих инструкций результатом исполнения
